...
func (m *MockSubscriptionWorker) SetPosition(arg0 context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetPosition", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetPosition indicates an expected call of SetPosition
func (mr *MockSubscriptionWorkerMockRecorder) SetPosition(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetPosition", reflect.TypeOf((*MockSubscriptionWorker)(nil).SetPosition), arg0)
}
